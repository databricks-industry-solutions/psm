...
# MAGIC %md
# MAGIC ## Notebooks
# MAGIC  * `1-data-ingest`: Ingesting raw data and write to delta
# MAGIC  * `2-data-prep-and-analysis`: Demonstrating cohort creation, exploratory analysis and writing data to delta lake
# MAGIC  * `3-psm`: Demonstrating training a binary classifier to estimate propencity scores for a target treatment and to perform propencity score mathcing using two methods of stratification and nearest neighbor matching
# MAGIC  * `cohort_builder`: cohort creation class based on synthea resources.
